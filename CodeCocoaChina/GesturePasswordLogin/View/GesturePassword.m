...
@interface GesturePassword()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout> {
//集合视图
...
- (void)buildUI {
    ...
    [_collectionView registerClass:[GesturePasswordCell class] forCellWithReuseIdentifier:@"GesturePasswordCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    static NSString* cellId = @"GesturePasswordCell";
    GesturePasswordCell* cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellId forIndexPath:indexPath];
...
- (void)updatePasswordIndexPathArr:(CGPoint)point {
    for (NSIndexPath *indexPath in _collectionView.indexPathsForVisibleItems) {
        GesturePasswordCell *cell = (GesturePasswordCell *)[_collectionView cellForItemAtIndexPath:indexPath];
